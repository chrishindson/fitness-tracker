...
public interface ActivityRepository extends JpaRepository<Activity, Long> {
  ...
  @Query(
      """
          ...
          """)
  Page<ActivitySummaryDTO> getActivitySummaryByFtUser(
  ...
  @Query(
      value =
          """
                ...
                GROUP BY u.username, a.activityDate
              """)
  ActivitySummaryDTO getActivitySummaryByFtUserAndActivityDate(
      @Param("user") FTUser user, @Param("activityDate") LocalDate activityDate);
  ...
  @Query(
      """
          ...
          """)
  Page<Activity> getActivitiesByFtUser(
      @Param("username") String username, @Param("pageable") Pageable pageable);
  ...
  @Query(
      """
          ...
          """)
  List<Activity> findByActivityDateAndUser(
      @Param("activityDate") LocalDate activityDate, @Param("user") FTUser user);
}
